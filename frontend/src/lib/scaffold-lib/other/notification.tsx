...
import { Icon, Icons, Spinner } from "lib";
...
const ENUM_STATUSES = {
  success: <Icon src={Icons.world} className="w-7 text-success" />,
  loading: <Spinner />,
  error: <Icon src={Icons.world} className="w-7 text-success" />,
  info: <Icon src={Icons.world} className="w-7 text-success" />,
  warning: <Icon src={Icons.world} className="w-7 text-success" />,
};
